"""
This is my toolbox module. I'll put procedures in here that I might
want to use again in the future. If I put something in here, I will
also print that procedure out and include it with my source code when
I turn in the first program that I use it on. After that, I won't have
to print it out and turn it in again.
To use any of these procedures, I would write:
